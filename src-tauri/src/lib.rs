...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            decompose::decompose_retry_failed,
            decompose::decompose_provider_balance,
            decompose::decompose_file_path,
            decompose::library_search,
            decompose::library_attach,
            decompose::library_detach,
            decompose::library_finalize,
            ...
            decompose::decompose_export_turnaround,
            decompose::decompose_export_combined_scene,
